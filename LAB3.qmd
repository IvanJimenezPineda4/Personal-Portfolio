...
*Figure 1: Complete schematic showing all off-board components, wiring junctions, and standard component symbols.*

![Block Diagram of the top-level module and submodules.](images/lab3_blockdiagram.jpg)
*Figure 2: Block diagram representing the Verilog code structure, including all submodules.*
...
*Figure 3: State transition diagram illustrating the row scanning, debouncing, and wait states.*
...
*Figure 4: FSM Testbench waveform confirming the scan, debounce, and wait state transitions.*

![Top Module testbench waveforms.](images/lab3_ivan_waves.png)
*Figure 5: Top level waveform confirming that simulated switch bounce is safely ignored and the shift register updates cleanly.*

![Keypad Decoder testbench waveforms.](images/lab3_decoder_waves.png)
*Figure 6: Keypad Decoder waveforms confirming that simulated keys are mapped correctly.

![Synchronizer testbench waveforms.](images/lab3_synchronizer_waves.png)
*Figure 7: Synchronizer testbench waveforms confirming that simulated synchronizer correctly drives asynchronous inputs on clock edge.
